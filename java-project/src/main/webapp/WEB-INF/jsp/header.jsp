...
<a class='navbar-brand' href='../../index.html'>
  <img src='${contextPath }/images/B.png' width='30' height='30' class='d-inline-block align-top' alt=''>
  비트캠프
</a>
...
<c:choose>
    ...
    <c:otherwise>
        <a href='${contextPath}/app/auth/login' class='btn btn-primary btn-sm'>로그인</a>
    </c:otherwise>
</c:choose>
</div>
</c:if>
