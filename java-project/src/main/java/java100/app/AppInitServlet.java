...
// 서블릿 컨테이너가 알아볼수 있도록 @WebServlet
@WebServlet(urlPatterns="/init", name = "AppInitServlet", loadOnStartup = 1) // loadOnStartup : 첫번째로 실행하라!
@Configuration
@ComponentScan("java100.app")
public class AppInitServlet implements Servlet {

    ServletConfig servletConfig;
    public static AnnotationConfigApplicationContext iocContainer; //다른곳에서 사용할 수 있도록
