...
<pre>
1. JSTL 라이브러리 다운로드
 - JSTL API와 이 API를 구현한 라이브러리를 다운로드합니다.
 - build.gradle에 라이브러리 정보를 추가합니다.
 - "gradlew eclipse" 실행하여 이클립스 설정 파일을 갱신한다.
2. JSP 페이지에 사용할 태그 라이브러리 정보를 추가
...
<h3>L10N</h3>
<p>Localization 의 약자이다.
국제화를 지원하도록 만든 프로그램에서 각 언어별로 텍스트 파일을 만든다.<br>
이 때 각 언어별로 라벨이나 메뉴에 출력될 텍스트 파일을 만드는 것을 말한다.<br>
